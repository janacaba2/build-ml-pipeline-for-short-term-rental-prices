...
def go(args):
    ...
    # YOUR CODE HERE
    ######################################
    tmp_dir = "random_forest_dir"
    mlflow.sklearn.save_model(sk_pipe, tmp_dir)
    ...
    type="model_export",
    description="Fitted sklearn random forest pipeline",
    metadata=rf_config
    )
...
def get_inference_pipeline(rf_config, max_tfidf_features):
    ...
    non_ordinal_categorical_preproc = Pipeline([("impute_na", SimpleImputer(strategy="most_frequent")),
                                                ("1h_encoding", OneHotEncoder())])
    ######################################
